...
class TensorboardCallback(Callback):
    ...
    def __init__(self, accelerator: Accelerator, output_dir, create_dir=True, exclude_metrics: Sequence[str] = None, epoch_log_interval: int = 1):
        """
    ...
    def on_fit_initialization(self, trainer):
        if self.accelerator.is_main_process and self.create_dir and not os.path.exists(self.tensorboard_dir):
