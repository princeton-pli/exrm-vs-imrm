...
class ExperimentsPlanRunner:
    ...
    def run(self, plan_config_path: str, experiment: Experiment, disable_console_log: bool = False, save_logs: bool = False,
            log_dir: str = "", log_file_name_prefix: str = "", overrides_dict: dict = None):
        """
        ...
        :param overrides_dict: dictionary of arguments to override in each run's configuration file
        """
        experiments_plan = ExperimentsPlan.load_from(plan_config_path, overrides_dict)
